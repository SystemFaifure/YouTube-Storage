...
- Compression artifacts can reduce decode accuracy with some codecs/settings. If accuracy is critical, prefer less lossy settings (for example, 'MJLS' + '.avi') and larger pixel sizes.
